export const projects = [
  {
    ...
    explanations: [
      'international science fair was where i learned building software can make a difference in the real world! this is where Bryce and I started building punch.',
  ...
  },
  {
    ...
    explanations: [
      ...
      'our biggest breakthroughs came after a game of hallway soccer.',
    ],
    quotes: [
...
export const collaborations = [
  
  {
    ...
    explanations: [
      ...
      'i love salt lake city and this area of the country!',
    ],
    quotes: [
      ...
      '"hey mom, click this link and let me know what your family thinks!"',
    ],
  },
  {
    ...
    explanations: [
      'i have always been interested in government, i paged for the Oklahoma House of Representatives under Darryl Fincher!',
      'lake lagunita is my favorite outdoor workspace at Stanford',
    ],
    quotes: [
  ...
  },
  {
    ...
    explanations: [
      'i went back to colombia and saw cycles of crime from childhood. i wanted to research and solve this.',
      'whiteboards are my best friend. it gets the brain going (even when drawing something totally unrelated)!',
    ],
    quotes: [
