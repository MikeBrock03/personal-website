...
function App() {
  ...
  const handleCloseClick = (event) => {
    if (event.target.classList.contains('project-details-overlay')) {
  ...
  const handleExplanationClose = (event) => {
    if (event.target.classList.contains('explanation-overlay')) {
  ...
  return (
    <div className="portfolio" >
      {selectedProject && (
        <div className="project-details-overlay" onClick={handleCloseClick}>
      ...
      {selectedExplanation && (
        <div className="explanation-overlay" onClick={handleExplanationClose}>
      ...
      <section className="center-section">
        ...
        <div className="row">
    <div className="col">
      <div className="item-container interactive">
      ...
      {collaborations.map((collaboration, index) => (
        <React.Fragment key={index}>
          ...
          <section className="center-section">
            <div className="row">
              <div className="col">
                <div className="item-container interactive" onClick={(event) => handleProjectClick(collaboration, event)}>
                {!selectedProject && <img src={tape} alt="tape" className="tape" />}
      ...
      {projects.map((project, index) => (
        <React.Fragment key={index}>
          ...
          <section className="center-section">
            <div className="row">
              <div className="col">
                <div className="item-container interactive" onClick={(event) => handleProjectClick(project, event)}>
                  {!selectedProject && <img src={tape} alt="tape" className="tape" />}
